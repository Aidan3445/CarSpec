...
class FakeFavoriteViewModelTest {
    ...
    @Test
    fun `when toggleFavorite is called with non-favorite car, it should add it to favorites`() = runTest {
    ...
    @Test
    fun `when toggleFavorite is called with favorite car, it should remove it from favorites`() = runTest {
